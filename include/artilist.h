...
A("Nodensfork",			TRIDENT,						"wave-etched %s",
	...
	PROPS(), NOFLAG,
	PROPS(HOLY_SHOCK_RES, WARN_OF_MON), NOFLAG,
	NOINVOKE, NOFLAG
	),
...
A("Mjollnir",			WAR_HAMMER,						"lightning-bolt embossed %s",
	...
	PROPS(HOLY_SHOCK_RES, BLIND_RES), NOFLAG,
	PROPS(), NOFLAG,
	NOINVOKE, NOFLAG
	),
...
A("The Shield of the All-Seeing",	ORCISH_SHIELD,		(const char *)0,
	...
	NO_ATTK(), NOFLAG,
	PROPS(SEARCHING, HELL_FIRE_RES, SEE_INVIS), (ARTP_SEEK),
	PROPS(WARN_OF_MON), NOFLAG,
...
A("Itlachiayaque",					ROUNDSHIELD,		(const char *)0,
	...
	NO_MONS(),
	NO_ATTK(), NOFLAG,
	PROPS(HELL_FIRE_RES, REFLECTING), NOFLAG,
...
A("The Heart of Ahriman",			RUBY,				(const char *)0,
	...
	ATTK(AD_PHYS, 10, 0), NOFLAG,
	PROPS(), NOFLAG,
	PROPS(ANTIMAGIC, REFLECTING, HALF_SPDAM, HELL_FIRE_RES, DRAIN_RES, POISON_RES), NOFLAG,
...
A("The Claws of the Revenancer",	GAUNTLETS_OF_DEXTERITY,			(const char *)0,
	...
	NO_MONS(),
	ATTK(AD_DRLI, 1, 1), (ARTA_DRAIN),
	PROPS(ENERGY_REGENERATION, DRAIN_RES, HELL_COLD_RES, REGENERATION, FIXED_ABIL, POISON_RES, SEE_INVIS), NOFLAG,
	PROPS(), NOFLAG,
	RAISE_UNDEAD, NOFLAG
	),
...
A("The Mantle of Heaven",			CLOAK,				(const char *)0,
	...
	NO_MONS(),
	NO_ATTK(), NOFLAG,
	PROPS(HOLY_SHOCK_RES, HALF_SPDAM), NOFLAG,
	PROPS(COLD_RES), NOFLAG,
	NOINVOKE, NOFLAG
	),
/*Needs encyc entry*/
...
A("The Vestment of Hell",			CLOAK,				(const char *)0,
	...
	NO_MONS(),
	NO_ATTK(), NOFLAG,
	PROPS(HELL_ACID_RES, HALF_PHDAM), NOFLAG,
	PROPS(HELL_FIRE_RES), NOFLAG,
	NOINVOKE, NOFLAG
	),
...
A("The War-mask of Durin",			MASK,				(const char *)0,
	...
	NO_MONS(),
	NO_ATTK(), NOFLAG,
	PROPS(HELL_FIRE_RES, ACID_RES, POISON_RES, HALF_SPDAM), NOFLAG,
	PROPS(), NOFLAG,
	NOINVOKE, NOFLAG
	),
...
A("The Steel Scales of Kurtulmak",	GRAY_DRAGON_SCALES,	(const char *)0,
	...
	NO_MONS(),
	NO_ATTK(), NOFLAG,
	PROPS(FREE_ACTION, HELL_FIRE_RES, REFLECTING, HALF_PHDAM), NOFLAG,
	PROPS(), NOFLAG,
	NOINVOKE, NOFLAG
	),
...
A("The Platinum Dragon Plate",		SILVER_DRAGON_SCALE_MAIL,			(const char *)0,
	...
	NO_MONS(),
	NO_ATTK(), NOFLAG,
	PROPS(ANTIMAGIC, HOLY_FIRE_RES, HOLY_COLD_RES, DISINT_RES, HOLY_SHOCK_RES, SLEEP_RES, FREE_ACTION), NOFLAG,
	PROPS(), NOFLAG,
	NOINVOKE, NOFLAG
	),
...
A("The Chromatic Dragon Scales",	BLACK_DRAGON_SCALES,			(const char *)0,
	...
	NO_MONS(),
	NO_ATTK(), NOFLAG,
	PROPS(HELL_FIRE_RES, HELL_COLD_RES, DISINT_RES, HELL_SHOCK_RES, POISON_RES, SICK_RES, HELL_ACID_RES, STONE_RES), NOFLAG,
	PROPS(), NOFLAG,
	NOINVOKE, NOFLAG
	),
