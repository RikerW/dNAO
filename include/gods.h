...
#define hell_safe_prayer(p_god)	(galign(p_god) || p_god == GOD_LOLTH || \
	(u.ualign.god == p_god && uarmh && uarmh->oartifact == ART_MITRE_OF_HOLINESS) || \
	(u.ualign.god == p_god && uwep && uwep->oartifact == ART_CENSER_OF_HOLINESS))
